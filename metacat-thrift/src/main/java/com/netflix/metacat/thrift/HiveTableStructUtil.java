...
/**
 * Utility class for Hive table struct field operations.
 * This class contains methods that require Hive dependencies.
 *
 * @author metacat team
 * @since 1.4.0
 */
