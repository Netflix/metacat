...
public class MetacatMySqlPlugin implements Plugin {
    ...
    public <T> List<T> getServices(Class<T> type)
    {
        if (type == ConnectorFactory.class) {
            return ImmutableList.of(type.cast(new MySqlJdbcConnectorFactory(NAME, MODULE, optionalConfig, getClassLoader())));
    ...
    {
        return firstNonNull(Thread.currentThread().getContextClassLoader(), MetacatMySqlPlugin.class.getClassLoader());
    }
}
