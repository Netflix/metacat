 ...
 *
 */
package com.netflix.metacat.common.server.connector.commonview;
...
public class CommonViewHandler {
     ...
     * @param icebergTypeConverter     iceberg type converter (unused in base implementation)
     * @return table info
     */
    public TableInfo getCommonViewTableInfo(final QualifiedName name,
                                            final String tableLoc,
                                            final TableInfo tableInfo,
                                            final IcebergTypeConverter icebergTypeConverter) {
