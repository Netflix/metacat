 ...
 */
@Getter
public abstract class AlreadyExistsException
    ...
    protected AlreadyExistsException(final QualifiedName name, final Throwable cause) {
    ...
    protected AlreadyExistsException(final QualifiedName name, final String message, final Throwable cause,
        final boolean enableSuppression, final boolean writableStackTrace) {
