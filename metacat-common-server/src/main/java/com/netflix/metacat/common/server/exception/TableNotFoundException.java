...
public class TableNotFoundException extends NotFoundException {
     ...
     */
    public TableNotFoundException(final QualifiedName name, final Throwable cause) {
        super(name, cause);
    }
     ...
     */
    public TableNotFoundException(final QualifiedName name, final Throwable cause, final boolean enableSuppression,
