...
class ValidatingConnectorCatalogServiceSpec extends Specification {
    def delegate
    def rateLimiter
    def authorization
    def context
    ...
    def "create"() {
        setup:
        service = new ValidatingConnectorCatalogService(delegate, rateLimiter, rateLimiterEnabled, authorization, authorizationEnabled)
