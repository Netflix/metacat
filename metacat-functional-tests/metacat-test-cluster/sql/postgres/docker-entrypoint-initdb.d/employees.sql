...
-- Conversion to PostgreSQL by Vraj Mohan
-- https://github.com/vrajmohan/pgsql-sample-data/blob/master/employee/employees.sql
...
\echo 'FINISHED CREATING DATABASE STRUCTURE'
