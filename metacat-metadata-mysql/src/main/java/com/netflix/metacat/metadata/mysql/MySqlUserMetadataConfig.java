...
import com.netflix.metacat.common.server.usermetadata.DefaultTableUUIDProvider;
...
public class MySqlUserMetadataConfig {
     ...
     *
     * @return The TableUUIDProvider implementation
     */
    @Bean
    @ConditionalOnMissingBean(TableUUIDProvider.class)
    public TableUUIDProvider tableUUIDProvider(
    ) {
        return new DefaultTableUUIDProvider();
    }
