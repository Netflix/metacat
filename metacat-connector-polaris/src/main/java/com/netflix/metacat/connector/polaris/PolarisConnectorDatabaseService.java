...
public class PolarisConnectorDatabaseService implements ConnectorDatabaseService {
    ...
    public void create(final ConnectorRequestContext context, final DatabaseInfo databaseInfo) {
        ...
        try {
            ...
            final Map<String, String> params = databaseInfo.getMetadata() == null
                ? new HashMap<>() : databaseInfo.getMetadata();
            this.polarisStoreService.createDatabase(name.getDatabaseName(), location, createdBy, params);
